  ...
  return (
    ...
    >
      <View style={signUpStyles.container}>
        ...
        <Text style={signUpStyles.subtitle}>Welcome to Red Maldita!</Text>
        <View>
          ...
          <View style={signUpStyles.section}>
            ...
            <TextInput
              ...
              autoCapitalize="none"
              keyboardType={'ubication'}
              blurOnSubmit={false}
              style={signUpStyles.textInput}
              onChangeText={(ubication) => setUser({ ...user, ubication: ubication })}
              onSubmitEditing={() => passInput.focus()}
            />
              <View style={signUpStyles.section}>
            <Icon name="at-outline" color="gray" type="ionicon" size={20} />
            <TextInput
              ...
              blurOnSubmit={false}
              style={signUpStyles.textInput}
              onChangeText={(birth) => setUser({ ...user, birth: birth })}
              onSubmitEditing={() => passInput.focus()}
            />
          </View>
          </View>
